...
class AppRouter extends _i24.RootStackRouter {
  ...
  final Map<String, _i24.PageFactory> pagesMap = {
    ...
    Notification_screen.name: (routeData) {
      return _i24.MaterialPageX<dynamic>(
        routeData: routeData,
        child: _i9.NotificationsScreen(),
      );
    },
    Favorite_interests_screen.name: (routeData) {
      return _i24.MaterialPageX<dynamic>(
        routeData: routeData,
        child: _i10.FavoriteInterestsScreen(),
      );
    },
    ...
    Feedback_screen.name: (routeData) {
      return _i24.MaterialPageX<dynamic>(
        routeData: routeData,
        child: _i13.FeedbackScreen(),
      );
    },
    Albums_screen.name: (routeData) {
      return _i24.MaterialPageX<dynamic>(
        routeData: routeData,
        child: _i14.AlbumsScreen(),
      );
    },
    Add_albums_screen.name: (routeData) {
      return _i24.MaterialPageX<dynamic>(
        routeData: routeData,
        child: const _i15.AddAlbumScreen(),
      );
    },
    ...
    Success_screen.name: (routeData) {
      ...
      return _i24.MaterialPageX<dynamic>(
        routeData: routeData,
        child: _i17.CustomSuccessScreen(
          key: args.key,
          child: args.child,
        ),
      );
    ...
    Configuration_screen.name: (routeData) {
      return _i24.MaterialPageX<dynamic>(
        routeData: routeData,
        child: _i18.ConfigurationScreen(),
      );
    },
    Home_partial.name: (routeData) {
      return _i24.MaterialPageX<dynamic>(
        routeData: routeData,
        child: _i19.HomePartial(),
      );
    },
    Me_authenticated_partial.name: (routeData) {
      return _i24.MaterialPageX<dynamic>(
        routeData: routeData,
        child: _i19.MeAuthenticatedPartial(),
      );
    },
    ...
    Unsync_couple_screen.name: (routeData) {
      return _i24.MaterialPageX<dynamic>(
        routeData: routeData,
        child: const _i21.UnsyncCoupleScreen(),
      );
    },
    Add_suggestions_screen.name: (routeData) {
      return _i24.MaterialPageX<dynamic>(
        routeData: routeData,
        child: const _i22.AddSuggestionScreen(),
      );
    },
    Login_wrapper_screen.name: (routeData) {
      return _i24.MaterialPageX<dynamic>(
        routeData: routeData,
        child: const _i23.LoginWrapperScreen(),
      );
    },
  };
  ...
  List<_i24.RouteConfig> get routes => [
        _i24.RouteConfig(
          Authentication_wrapper_screen.name,
          path: '/',
        ),
        _i24.RouteConfig(
          Root_screen_manager_screen.name,
          path: '/root-screen-manager',
        ),
        _i24.RouteConfig(
          Onboarding_screen.name,
          path: '/on-boarding-screen',
        ),
        _i24.RouteConfig(
          Search_places_screen.name,
          path: '/search-places-screen',
        ),
        _i24.RouteConfig(
          Place_item_details_screen.name,
          path: '/place-item-details',
        ),
        _i24.RouteConfig(
          Interest_screen.name,
          path: '/interest-screen',
        ),
        _i24.RouteConfig(
          Add_time_line_screen.name,
          path: '/add-time-line-screen',
        ),
        _i24.RouteConfig(
          Gallery_photo_view_wrapper_screen.name,
          path: '/gallery-photo-view-wrapper',
        ),
        _i24.RouteConfig(
          Notification_screen.name,
          path: '/notifications-screen',
        ),
        _i24.RouteConfig(
          Favorite_interests_screen.name,
          path: '/favorite-interests-screen',
        ),
        _i24.RouteConfig(
          Add_calendar_screen.name,
          path: '/add-calendar-screen',
        ),
        _i24.RouteConfig(
          Add_activity_screen.name,
          path: '/add-activity-screen',
        ),
        _i24.RouteConfig(
          Feedback_screen.name,
        ...
        _i24.RouteConfig(
          Add_albums_screen.name,
          path: '/add-album-screen',
        ),
        _i24.RouteConfig(
          Edit_albums_screen.name,
        ...
        _i24.RouteConfig(
          Unsync_couple_screen.name,
          path: '/unsync-couple-screen',
        ),
        _i24.RouteConfig(
          Add_suggestions_screen.name,
          path: '/add-suggestion-screen',
        ),
        _i24.RouteConfig(
          Login_wrapper_screen.name,
...
class Place_item_details_screen
  ...
  Place_item_details_screen({
    _i25.Key? key,
    required _i26.PlaceModel? item,
  }) : super(
          Place_item_details_screen.name,
          path: '/place-item-details',
          args: Place_item_details_screenArgs(
            key: key,
            item: item,
          ),
        );
...
class Place_item_details_screenArgs {
  const Place_item_details_screenArgs({
    this.key,
    required this.item,
  });
...
class Interest_screen extends _i24.PageRouteInfo<Interest_screenArgs> {
  Interest_screen({
    _i25.Key? key,
    required bool? isChangeFilter,
  }) : super(
          Interest_screen.name,
          path: '/interest-screen',
          args: Interest_screenArgs(
            key: key,
...
class Interest_screenArgs {
  const Interest_screenArgs({
    this.key,
    required this.isChangeFilter,
  });
...
class Gallery_photo_view_wrapper_screen
  ...
  Gallery_photo_view_wrapper_screen({
    _i25.Widget Function(
      _i25.BuildContext,
      _i25.ImageChunkEvent?,
    )?
        loadingBuilder,
...
class Edit_albums_screen extends _i24.PageRouteInfo<Edit_albums_screenArgs> {
  Edit_albums_screen({
    _i25.Key? key,
    required _i32.AlbumItemModel? album,
  }) : super(
          Edit_albums_screen.name,
          path: '/edit-album-screen',
          args: Edit_albums_screenArgs(
            key: key,
            album: album,
          ),
        );
...
class Success_screen extends _i24.PageRouteInfo<Success_screenArgs> {
  Success_screen({
    _i25.Key? key,
    required _i25.Widget child,
  }) : super(
          Success_screen.name,
          path: '/custom-success-screen',
          args: Success_screenArgs(
            key: key,
            child: child,
          ),
        );
...
class Invite_screen extends _i24.PageRouteInfo<Invite_screenArgs> {
  Invite_screen({
    _i25.Key? key,
    required _i33.InviteCubit? inviteCubit,
  }) : super(
          Invite_screen.name,
          path: '/invite-screen',
          args: Invite_screenArgs(
            key: key,
